...
function fotoSheathe() {
	var FotoY = $('.row-basics').offset().top;
	var navPos = $('.main-navigate').offset().top;
	console.log('pozycja opisu FotoY to '+FotoY);
	console.log('pozycja nawigacji navPos to '+navPos);
